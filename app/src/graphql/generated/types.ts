    ...
    Array<
      Maybe<
        { __typename?: "Project" } & Pick<
          Project,
          "id" | "title" | "description" | "created_at" | "updatedAt"
        > & {
            projectType?: Maybe<
              { __typename?: "ProjectType" } & Pick<
                ProjectType,
                "id" | "description"
              >
            >;
              ...
              Array<
                { __typename?: "ProjectToProjectFeature" } & {
                  ProjectFeature?: Maybe<
                    { __typename?: "ProjectFeature" } & Pick<
                      ProjectFeature,
                      "id" | "description"
                    >
                  >;
            ...
            skills?: Maybe<
              Array<
                { __typename?: "ProjectToSkill" } & {
                  skill?: Maybe<
                    { __typename?: "Skill" } & Pick<Skill, "id" | "description">
                  >;
                }
              >
            >;
...
> = {
  ...
  projectFeatures?: Resolver<
    Maybe<Array<ResolversTypes["ProjectToProjectFeature"]>>,
    ParentType,
    ContextType
  >;
  projectStatuses?: Resolver<
    Maybe<Array<ResolversTypes["ProjectToProgressStatus"]>>,
    ParentType,
    ContextType
  >;
  skills?: Resolver<
    Maybe<Array<ResolversTypes["ProjectToSkill"]>>,
    ParentType,
    ContextType
  >;
  usersLiked?: Resolver<
  ...
  usersRequested?: Resolver<
    Maybe<Array<ResolversTypes["JoinRequest"]>>,
    ParentType,
    ContextType
  >;
  usersAsked?: Resolver<
    Maybe<Array<ResolversTypes["Qa"]>>,
    ParentType,
    ContextType
  >;
  created_at?: Resolver<
...
> = {
  ...
  >;
  skills?: Resolver<
    Maybe<Array<ResolversTypes["SkillToUser"]>>,
    ParentType,
    ContextType
  >;
